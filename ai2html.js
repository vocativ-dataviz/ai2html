...
if (scriptEnvironment=="prod") {
	var ai2htmlBaseSettings = {
	        ...
	        credit: {defaultValue: "By Vocativ", includeInSettingsBlock: true, includeInConfigFile: true, useQuoteMarksInConfigFile: true, inputType: "text", possibleValues: "", notes: ""},
	        page_template: {defaultValue: "vv-article-embed", includeInSettingsBlock: true, includeInConfigFile: true, useQuoteMarksInConfigFile: false, inputType: "text", possibleValues: "", notes: ""},
	        publish_system: {defaultValue: "wordpress", includeInSettingsBlock: false, includeInConfigFile: true, useQuoteMarksInConfigFile: false, inputType: "text", possibleValues: "", notes: ""},
	...
	var ai2htmlBaseSettings = {
	        ...
	        credit: {defaultValue: "Vocativ", includeInSettingsBlock: true, includeInConfigFile: true, useQuoteMarksInConfigFile: true, inputType: "text", possibleValues: "", notes: ""},
